        ...
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden items-center gap-1 sm:flex">
              <div className="flex bg-secondary/30 rounded-lg p-0.5 mr-2 border border-border/50">
                <button
            ...
            {status === "authenticated" ? (
              ...
              <div className="h-9 w-24 bg-card/40 animate-pulse rounded-full border border-border hidden md:block" />
            ) : (
            ...
            <div className="mt-4 flex flex-col gap-3 px-4 pb-6 border-t border-border/50 pt-6">
              {status === "authenticated" ? (
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="col-span-2 flex bg-secondary/30 rounded-lg p-0.5 mb-2 border border-border/50">
                    <button
                      onClick={() => setLocale("pt")}
                      className={cn(
                        "flex-1 px-2 py-2.5 rounded-md font-mono text-xs uppercase transition-all",
                        locale === "pt"
                          ? "bg-primary text-primary-foreground shadow-sm"
