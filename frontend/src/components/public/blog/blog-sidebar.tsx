...
const categoriesByLocale = {
  pt: [
    { name: "Todos os Posts", count: 12, slug: "all" },
    { name: "IA & Machine Learning", count: 4, slug: "ai" },
    { name: "Frontend", count: 3, slug: "frontend" },
    { name: "Sistemas & DevOps", count: 3, slug: "systems" },
  ...
  fr: [
    { name: "Tous les articles", count: 12, slug: "all" },
    { name: "IA & Apprentissage automatique", count: 4, slug: "ai" },
    { name: "Front-end", count: 3, slug: "frontend" },
    { name: "Systèmes & DevOps", count: 3, slug: "systems" },
    { name: "Design", count: 2, slug: "design" },
  ],
}
    ...
    <aside ref={sidebarRef} className="space-y-8 lg:sticky lg:top-28 lg:self-start">
      ...
      <div className={cn("opacity-0", isVisible && "animate-fade-in-up stagger-1")}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{t("blog.categories")}</h3>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{t("blog.newsletter")}</h3>
        </div>
      ...
      <div className={cn("opacity-0", isVisible && "animate-fade-in-up stagger-4")}>
        ...
        >
          ...
          <span>{t("blog.subscribe_rss")}</span>
        </a>
      </div>
    </aside>
  )
