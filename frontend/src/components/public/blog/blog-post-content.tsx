    ...
    <>
      ...
      <section className="relative px-4 sm:px-6 pt-28 sm:pt-32 pb-12 sm:pb-16 border-b border-border/30">
        ...
        <div className="mx-auto max-w-4xl relative z-10">
          ...
          >
            ...
            <span className="font-mono">{t("blog.back_to_blog")}</span>
          </Link>
      ...
      <section className="px-4 sm:px-6 py-12 sm:py-16">
        <div className="mx-auto max-w-4xl">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto]">
            ...
            >
              <div className="sticky top-32 flex flex-col gap-3">
                <span className="font-mono text-xs text-muted-foreground mb-2 text-center">{t("blog.share")}</span>
                <Button
                  variant="outline"
                  size="icon"
                ...
                >
                  ...
                  <span className="sr-only">{t("blog.share_on_twitter")}</span>
                </Button>
                <Button
                  variant="outline"
                  size="icon"
                ...
                >
                  ...
                  <span className="sr-only">{t("blog.share_on_linkedin")}</span>
                </Button>
                <Button
                  variant="outline"
                  size="icon"
                ...
                >
                  ...
                  <span className="sr-only">{t("blog.copy_link")}</span>
                </Button>
                <Button
                  variant="outline"
                  size="icon"
                ...
                >
                  ...
                  <span className="sr-only">{t("blog.bookmark")}</span>
                </Button>
              </div>
            </aside>
          </div>
          ...
          >
            <span className="font-mono text-xs text-muted-foreground">{t("blog.share_label")}</span>
            <Button
              variant="outline"
              size="icon"
          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight">
                {t("blog.continue_reading").split(" ").slice(0, -1).join(" ")}{" "}
                <span className="bg-gradient-to-l from-primary/50 to-accent text-transparent bg-clip-text">
                  {t("blog.continue_reading").split(" ").slice(-1)}
                </span>
              </h2>
            </div>
