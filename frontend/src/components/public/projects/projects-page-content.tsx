...
const filterKeys = ["all", "shipped", "in-progress", "archived"] as const

const filterLabelsByLocale = {
  pt: {
    all: "tudo",
    shipped: "lançado",
...
export function ProjectsPageContent() {
  ...
  const labels = filterLabelsByLocale[locale]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-20">
            <p className="font-mono text-sm text-muted-foreground">{t("projects.no_results")}</p>
          </div>
        )}
      </div>
    </section>
