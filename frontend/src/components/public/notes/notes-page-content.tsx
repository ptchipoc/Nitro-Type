...
const categoryKeys = ["all", "frontend", "ai", "systems", "devops"] as const
    ...
    <section className="px-4 sm:px-6 py-12 sm:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className={cn("mb-12 sm:mb-16 space-y-4 opacity-0", isVisible && "animate-fade-in-up")}>
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">{t("notes.title")}</h1>
          ...
          <div className="lg:col-span-3">
            ...
            {filteredNotes.length === 0 && (
              <div className="text-center py-20">
                <p className="font-mono text-sm text-muted-foreground">{t("notes.no_results")}</p>
              </div>
            )}
          </div>
        </div>
